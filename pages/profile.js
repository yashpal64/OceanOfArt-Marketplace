...
export default function Hero() {
  ...
  return (
    <div className="justify-center items-start overflow-hidden">
        <Header/>
      <div className="flex justify-center text-center md:text-left lg:p-12" >
      <div class="justify-center bg-[#202225] rounded-lg shadow-md sm:p-6 dark:bg-[#202225]">
        <h3 class="mb-3 text-5xl font-semibold text-white dark:text-white">
            Connect your wallet.
        </h3>
        <p class="text-2xl font-normal text-gray-400 dark:text-gray-400 p-2">Connect with one of our available wallet providers or create a new one.</p>
        <ul class="my-4 space-y-3">
            <li>
                <a href="#" class="flex items-center p-3 text-base font-bold text-white bg-[#202225] rounded-lg hover:bg-gray-500 group hover:shadow dark:bg-[#202225] dark:hover:bg-gray-500 dark:text-white">
                    ...
                    <span class="flex-1 ml-3 whitespace-nowrap text-xl">MetaMask</span>
                    <span class="inline-flex items-center justify-center px-2 py-0.5 ml-3 text-xs font-medium text-gray-700 bg-gray-400 rounded dark:bg-gray-700 dark:text-gray-400">Popular</span>
                </a>
            </li>
            <li>
                <a href="#" class="flex items-center p-3 text-base font-bold text-white bg-[#202225] rounded-lg hover:bg-gray-500 group hover:shadow dark:bg-[#202225] dark:hover:bg-gray-500 dark:text-white">
                    ...
                    <span class="flex-1 ml-3 whitespace-nowrap text-xl">Coinbase Wallet</span>
                </a>
            </li>
            <li>
                <a href="#" class="flex items-center p-3 text-base font-bold text-white bg-[#202225] rounded-lg hover:bg-gray-500 group hover:shadow dark:bg-[#202225] dark:hover:bg-gray-500 dark:text-white">
                    <img height={20} width={20} src="https://storage.opensea.io/static/wallets/walletconnect/walletconnect-alternative.png"></img>
                    <span class="flex-1 ml-3 whitespace-nowrap text-xl">WalletConnect</span>
                </a>
            </li>
            <li>
                <a href="#" class="flex items-center p-3 text-base font-bold text-white bg-[#202225] rounded-lg hover:bg-gray-500 group hover:shadow dark:bg-[#202225] dark:hover:bg-gray-500 dark:text-white">
                    ...
                    <span class="flex-1 ml-3 whitespace-nowrap text-xl">Fortmatic</span>
                </a>
            </li>
        </ul>
        <div>
            <a href="https://metamask.io/faqs/" class="inline-flex items-center text-xs font-normal text-white hover:underline dark:text-white">
